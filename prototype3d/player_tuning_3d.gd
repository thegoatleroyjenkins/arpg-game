...
@export var light_attack_hit_stamina_restore: float = 4.0
@export var light_attack_crit_stamina_restore_bonus: float = 2.0
...
@export_range(0.0, 2.0, 0.05) var light_attack_targeting_execute_bias_weight: float = 0.35
